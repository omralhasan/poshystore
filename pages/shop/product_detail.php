...
<head>
    ...
    <style>
        ...
        /* SUPER SIMPLE MOBILE VIEW - PHONES ONLY */
        @media (max-width: 640px) {
            ...
            /* Quantity controls - make simple and large */
            .quantity-controls {
                width: 100%;
                padding: 1rem;
                border: 2px solid var(--purple-color);
            ...
            /* Video container - not needed on mobile */
            .video-container, .no-video-placeholder {
                display: none;
            }

            /* Lightbox still works but better for mobile */
            .lightbox-img {
                max-width: 95vw;
            }
