...
.pd-btn-primary{background:linear-gradient(135deg,var(--gold-color),var(--royal-gold));color:#fff}
.pd-btn-primary:hover:not(:disabled){transform:translateY(-2px);box-shadow:0 6px 20px rgba(201,168,106,.4);color:#fff}
