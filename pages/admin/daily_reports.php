...
$sql = "SELECT o.id as order_id, o.user_id, o.total_amount, o.status, o.order_type,
        ...
        LEFT JOIN (
            SELECT oi.order_id,
                    SUM(COALESCE(oi.cost_per_item, COALESCE(p.cost, COALESCE(p.supplier_cost, 0)), 0) * oi.quantity) AS total_cost,
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="date-selector">
                ...
                <a href="/pages/admin/admin_panel.php" class="btn btn-secondary">
