...
<div class="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <a href="/pages/admin/manage_banners.php"    class="nav-item active"><i class="fas fa-images"></i><span>Homepage Banners</span></a>
        <a href="/pages/admin/upload_center.php"     class="nav-item"><i class="fas fa-cloud-upload-alt"></i><span>Upload Center</span></a>
