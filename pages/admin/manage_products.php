...
<div class="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <a href="/pages/admin/manage_products.php"    class="nav-item active"><i class="fas fa-tag"></i><span>Products</span></a>
    ...
    <div class="filter-bar">
        <form method="GET" id="filterForm" style="display:contents;">
            ...
            <?php if ($search || $cat_filter || $brand_filter || $stock_filter): ?>
                <a href="/pages/admin/manage_products.php" class="btn btn-secondary btn-sm"><i class="fas fa-times"></i> Clear</a>
            <?php endif; ?>
        </form>
    </div>
                        ...
                        <tr id="product-row-<?= $p['id'] ?>">
                            ...
                            <td>
                                <div class="actions-cell">
                                    <a href="/pages/admin/edit_product.php?id=<?= $p['id'] ?>" class="btn btn-primary btn-sm" title="Edit all details">
