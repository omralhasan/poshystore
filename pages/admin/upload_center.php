...
<aside class="sidebar-panel fixed inset-y-0 left-0 z-50 w-72 bg-gradient-to-b from-panel-900 to-panel-800 text-white flex flex-col transition-transform duration-300 lg:translate-x-0 shadow-2xl">
    ...
    <nav class="flex-1 py-5 space-y-0.5 overflow-y-auto">
        <a href="admin_panel.php"       class="flex items-center gap-3 px-6 py-3 text-panel-400 hover:text-white hover:bg-white/5 transition-all border-l-[3px] border-transparent"><i class="fas fa-box w-5 text-center"></i><span>Orders</span></a>
        <a href="manage_products.php"   class="flex items-center gap-3 px-6 py-3 text-panel-400 hover:text-white hover:bg-white/5 transition-all border-l-[3px] border-transparent"><i class="fas fa-tag w-5 text-center"></i><span>Products</span></a>
        ...
        <a href="manage_coupons.php"    class="flex items-center gap-3 px-6 py-3 text-panel-400 hover:text-white hover:bg-white/5 transition-all border-l-[3px] border-transparent"><i class="fas fa-ticket-alt w-5 text-center"></i><span>Coupons</span></a>
        <a href="manage_categories.php" class="flex items-center gap-3 px-6 py-3 text-panel-400 hover:text-white hover:bg-white/5 transition-all border-l-[3px] border-transparent"><i class="fas fa-layer-group w-5 text-center"></i><span>Categories</span></a>
        <a href="manage_brands.php"     class="flex items-center gap-3 px-6 py-3 text-panel-400 hover:text-white hover:bg-white/5 transition-all border-l-[3px] border-transparent"><i class="fas fa-copyright w-5 text-center"></i><span>Brands</span></a>
        <a href="manage_banners.php"    class="flex items-center gap-3 px-6 py-3 text-panel-400 hover:text-white hover:bg-white/5 transition-all border-l-[3px] border-transparent"><i class="fas fa-images w-5 text-center"></i><span>Banners</span></a>
        <a href="upload_center.php"     class="flex items-center gap-3 px-6 py-3 text-accent-blue bg-accent-blue/10 border-l-[3px] border-accent-blue font-semibold"><i class="fas fa-cloud-upload-alt w-5 text-center"></i><span>Upload Center</span></a>
        <a href="daily_reports.php"     class="flex items-center gap-3 px-6 py-3 text-panel-400 hover:text-white hover:bg-white/5 transition-all border-l-[3px] border-transparent"><i class="fas fa-chart-line w-5 text-center"></i><span>Reports</span></a>
    ...
    <div class="p-4 border-t border-white/10">
        <a href="../auth/logout.php" class="flex items-center justify-center gap-2 w-full py-3 bg-gradient-to-r from-red-500 to-red-600 rounded-xl font-semibold text-sm shadow-lg shadow-red-500/30 hover:-translate-y-0.5 transition-all"><i class="fas fa-sign-out-alt"></i><span>Logout</span></a>
    </div>
</aside>
...
<main class="flex-1 lg:ml-72 p-4 md:p-8 overflow-x-hidden">
    ...
    <div class="bg-white rounded-2xl shadow-md p-6 mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <a href="admin_panel.php" class="inline-flex items-center gap-2 px-5 py-2.5 bg-panel-100 text-panel-600 rounded-xl text-sm font-semibold hover:bg-panel-200 transition-all">
