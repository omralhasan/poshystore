                ...
                <div class="col-md-6">
                    <div class="card-ramadan p-4">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 8px;">
                                    ...
                                    <a href="<?= BASE_PATH ?>/pages/auth/forgot_password.php" style="color: var(--gold-color); font-size: 0.85rem; text-decoration: none; font-weight: 500;">
                        ...
                        <div class="text-center mt-4">
                            <p class="mb-0">
                                <?= t('dont_have_account') ?> <a href="<?= BASE_PATH ?>/pages/auth/signup.php" class="auth-link"><?= t('sign_up') ?></a>
                            </p>
                            <p class="mb-0 mt-2">
