...
<body>
    <div class="card">
        ...
        <?php if ($success): ?>
            ...
            <div class="back-link">
                <a href="/pages/auth/signin.php" class="btn-ramadan" style="display:inline-block;text-decoration:none;text-align:center;margin-top:0.5rem;">
        ...
        <?php elseif ($error && !$valid_token): ?>
            ...
            <div class="back-link">
                <a href="/pages/auth/forgot_password.php"><i class="fas fa-redo me-1"></i> Request New Reset Link</a>
            </div>
        <?php endif; ?>
        ...
        <div class="back-link">
            <a href="/pages/auth/signin.php"><i class="fas fa-arrow-<?= $current_lang === 'ar' ? 'right' : 'left' ?> me-1"></i> Back to Sign In</a>
        </div>
        <?php endif; ?>
    </div>
