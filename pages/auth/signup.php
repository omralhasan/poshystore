...
<head>
    ...
    <title><?= t('sign_up') ?> - Poshy Store</title>
...
<body>
    ...
    if (isset($_GET['success'])) {
        ...
        echo '<div class="alert-ramadan alert-success"><i class="fas fa-check-circle me-2"></i>✅ ' . t('registration_successful') . ' <a href="signin.php" style="color: #155724; font-weight: bold; text-decoration: underline;">' . t('sign_in_now') . '</a> ' . t('to_start_shopping') . '.</div>';
        echo '</div>';
                ...
                <div class="col-md-7">
                    <div class="card-ramadan p-4">
                        ...
                        <form action="process_signup.php" method="POST">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" id="firstname" name="firstname" class="form-control-ramadan" required placeholder="<?= t('enter_first_name') ?>">
                                </div>
                                
                                <div class="col-md-6 mb-3">
                                    <label for="lastname" class="form-label" style="color: var(--gold-color); font-weight: 500;"><?= t('last_name') ?></label>
                                    <input type="text" id="lastname" name="lastname" class="form-control-ramadan" required placeholder="<?= t('enter_last_name') ?>">
                                </div>
                            </div>
                            
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="phonenumber" class="form-label" style="color: var(--gold-color); font-weight: 500;"><?= t('phone_number') ?></label>
                                    <input type="tel" id="phonenumber" name="phonenumber" class="form-control-ramadan" required placeholder="<?= t('enter_phone_number') ?>">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="password" id="password" name="password" class="form-control-ramadan" required placeholder="<?= t('enter_password') ?>" minlength="6">
                                </div>
                                
                                <div class="col-md-6 mb-3">
                                    <label for="confirm_password" class="form-label" style="color: var(--gold-color); font-weight: 500;"><?= t('confirm_password') ?></label>
                                    <input type="password" id="confirm_password" name="confirm_password" class="form-control-ramadan" required placeholder="<?= t('confirm_your_password') ?>" minlength="6">
                                </div>
                            </div>
                        ...
                        <div class="text-center mt-4">
                            <p class="mb-0">
                                <?= t('already_have_account') ?> <a href="signin.php" class="auth-link"><?= t('sign_in') ?></a>
                            </p>
                            <p class="mb-0 mt-2">
