...
<body>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div style="display: flex; gap: 8px; align-items: center; margin-top: 8px;">
                                            <select class="invoice-type-select" id="invoice-type-<?= $order['order_id'] ?>" style="flex: 1; padding: 6px 10px; border: 1px solid var(--border-color); border-radius: 6px; font-size: 0.875rem; background: white;">
                                                <option value="customer">Customer Invoice</option>
                                                <option value="supplier">Supplier Invoice</option>
                                            </select>
                                            <button class="btn-print" onclick="printInvoice(<?= $order['order_id'] ?>)" style="flex: 0 0 auto;">
    ...
    <script>
        ...
        function printInvoice(orderId) {
            const invoiceTypeEl = document.getElementById('invoice-type-' + orderId);
