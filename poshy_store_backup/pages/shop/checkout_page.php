...
$user_phone = '';
$stmt = $conn->prepare("SELECT phonenumber FROM users WHERE id = ?");
...
<head>
    ...
    <title>Checkout - Poshy Store</title>
    ...
    <div class="container py-5">
        ...
        <div style="max-width: 800px; margin: 0 auto 3rem auto;">
            <div style="display: flex; justify-content: space-between; align-items: center; position: relative;">
                ...
                <div style="position: relative; z-index: 1; text-align: center; flex: 1;">
                    ...
                    <small style="color: var(--purple-color); font-weight: 600; display: block; margin-top: 0.5rem;">Cart</small>
                </div>
                ...
                <div style="position: relative; z-index: 1; text-align: center; flex: 1;">
                    ...
                    <small style="color: var(--gold-color); font-weight: 700; display: block; margin-top: 0.5rem;">Checkout</small>
                </div>
        ...
        <div class="text-center mb-5">
            <h2 class="section-title-ramadan mb-2" style="font-size: 2.5rem;">
                <i class="fas fa-credit-card me-3" style="color: var(--gold-color);"></i>Checkout
            </h2>
            <p style="color: var(--gold-color); font-size: 1.1rem; margin-bottom: 1rem;">Complete your order</p>
                ...
                <div class="col-12">
                    <div class="card-ramadan p-4 mb-4" style="box-shadow: 0 4px 15px rgba(0,0,0,0.1); border: 2px solid rgba(201, 168, 106, 0.2);">
                        <h4 class="mb-4" style="color: var(--purple-color); font-weight: 700; border-bottom: 2px solid var(--gold-color); padding-bottom: 0.75rem;">
                            <i class="fas fa-user me-2" style="color: var(--gold-color);"></i>Customer Information
                        </h4>
                        <div class="row g-3">
                            <div class="col-md-6">
                        ...
                        <div class="mb-5">
                            <ul class="nav nav-pills justify-content-center" role="tablist" style="background: linear-gradient(135deg, #f8f5ff 0%, #fff9f5 100%); border-radius: 12px; padding: 0.5rem;">
                                ...
                                <li class="nav-item" role="presentation" style="flex: 1; margin-left: 0.5rem;">
                                    ...
                                    >
                                        <i class="fas fa-gift me-2"></i>Gift Order
                                    </button>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="tab-content" style="margin-top: 2rem;">
                            ...
                            <div class="tab-pane fade show active" id="shipping-content" role="tabpanel" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%); padding: 2.5rem; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); border: 2px solid rgba(201, 168, 106, 0.15);">
                                <div style="background: linear-gradient(135deg, #e8f4f8 0%, #f0f8ff 100%); border-left: 5px solid var(--purple-color); padding: 1.5rem; border-radius: 12px; margin-bottom: 2rem; box-shadow: 0 2px 10px rgba(72, 54, 110, 0.1);">
                                    <strong style="color: var(--purple-color); font-size: 1.15rem;"><i class="fas fa-truck me-2"></i>Standard Delivery</strong>
                                    <p style="color: #555; margin: 0.5rem 0 0 0; font-size: 0.95rem;">Please provide your shipping details for order delivery</p>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" style="color: var(--gold-color); font-weight: 600; font-size: 1rem; margin-bottom: 0.75rem; display: block;">
                                        <i class="fas fa-phone me-2" style="color: var(--purple-color);"></i>Phone Number <span style="color: #dc3545;">*</span>
                                    </label>
                                    <input 
                                        type="tel" 
                                        name="phone" 
                                    ...
                                    <small class="text-muted" style="display: block; margin-top: 0.5rem; font-size: 0.875rem;">
                                        <i class="fas fa-info-circle me-1" style="color: var(--gold-color);"></i> We'll call you to confirm delivery details
                                    </small>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" style="color: var(--gold-color); font-weight: 600; font-size: 1rem; margin-bottom: 0.75rem; display: block;">
                                        <i class="fas fa-city me-2" style="color: var(--purple-color);"></i>City <span style="color: #dc3545;">*</span>
                                    </label>
                                    <input 
                                        type="text" 
                                        name="city" 
                                        ...
                                        class="form-control-ramadan" 
                                        required 
                                        placeholder="Enter your city (e.g., Amman, Irbid)"
                                        pattern="[A-Za-z\s]{2,50}"
                                        title="Please enter a valid city name"
                                        style="font-size: 1rem; padding: 0.875rem; border-width: 2px;"
                                    >
                                    <small class="text-muted" style="display: block; margin-top: 0.5rem; font-size: 0.875rem;">
                                        <i class="fas fa-info-circle me-1" style="color: var(--gold-color);"></i> Required for delivery routing
                                    </small>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" style="color: var(--gold-color); font-weight: 600; font-size: 1rem; margin-bottom: 0.75rem; display: block;">
                                        <i class="fas fa-map-marked-alt me-2" style="color: var(--purple-color);"></i>Shipping Address <span style="color: #dc3545;">*</span>
                                    </label>
                                    <textarea 
                                        ...
                                        class="form-control-ramadan" 
                                        required 
                                        placeholder="Enter your full delivery address (street, building, floor)..."
                                        rows="4"
                                        style="font-size: 1rem; font-weight: 500; line-height: 1.6; padding: 1rem; border-width: 2px; resize: vertical;"
                                    ></textarea>
                                    <small class="text-muted" style="display: block; margin-top: 0.5rem; font-size: 0.875rem;">
                                        <i class="fas fa-info-circle me-1" style="color: var(--gold-color);"></i> Please provide complete address including street name, building number, floor, and any landmarks
                                    </small>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" style="color: var(--gold-color); font-weight: 600; font-size: 1rem; margin-bottom: 0.75rem; display: block;">
                                        <i class="fas fa-comment-dots me-2" style="color: var(--purple-color);"></i>Order Notes <span style="color: #888; font-weight: 400; font-size: 0.9rem;">(Optional)</span>
                                    </label>
                                    <textarea 
                                        name="notes" 
                                        id="notes"
                                        class="form-control-ramadan" 
                                        placeholder="Any special delivery instructions, preferred time, or additional comments..."
                                        rows="3"
                                        style="font-size: 1rem; line-height: 1.6; padding: 1rem; border-width: 2px; resize: vertical;"
                                    ></textarea>
                                    <small class="text-muted" style="display: block; margin-top: 0.5rem; font-size: 0.875rem;">
                                        <i class="fas fa-lightbulb me-1" style="color: var(--gold-color);"></i> Example: "Please deliver after 5 PM" or "Call before delivery"
                                    </small>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="gift-content" role="tabpanel" style="background: linear-gradient(135deg, #fff5f8 0%, #fffbf5 100%); padding: 2.5rem; border-radius: 16px; box-shadow: inset 0 0 40px rgba(236, 72, 153, 0.1), 0 4px 20px rgba(236, 72, 153, 0.15); position: relative; overflow: hidden; border: 2px solid rgba(236, 72, 153, 0.2);">
                                ...
                                <div class="alert" style="background: linear-gradient(135deg, #ffe6f7 0%, #fff0fb 100%); border: 2px dashed #ec4899; border-radius: 12px; padding: 1.25rem; margin-bottom: 2rem; box-shadow: 0 4px 12px rgba(236, 72, 153, 0.15); position: relative; z-index: 1;">
                                    <div style="display: flex; align-items: center; gap: 1rem;">
                                        ...
                                        <div>
                                            <strong style="color: #be185d; font-size: 1.1rem;">💝 Sending a gift?</strong>
                                            <p style="color: #831843; margin: 0.25rem 0 0 0; font-size: 0.95rem;">We'll make it unforgettable with beautiful wrapping and your heartfelt message!</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style="background: linear-gradient(135deg, #fff 0%, #fffbfe 100%); border-radius: 12px; padding: 1.5rem; margin-bottom: 2rem; border: 2px solid #ffc0e0; box-shadow: 0 4px 12px rgba(236, 72, 153, 0.1); position: relative; z-index: 1;">
                                    <h5 style="color: #be185d; margin-bottom: 1.5rem; font-weight: 700; font-size: 1.2rem; text-align: center;">
                                        <i class="fas fa-gift me-2" style="color: #ec4899;"></i>Gift Details
                                    </h5>
                                
                                    <div class="mb-4">
                                        <label class="form-label" style="color: #be185d; font-weight: 600; font-size: 1rem; margin-bottom: 0.75rem; display: block;">
                                            <i class="fas fa-user-heart me-2" style="color: #ec4899;"></i>Recipient Name <span style="color: #dc3545;">*</span>
                                        </label>
                                        <input 
                                            type="text" 
                                        ...
                                        <small style="color: #be185d; display: block; margin-top: 0.5rem; font-size: 0.875rem;">
                                            <i class="fas fa-info-circle me-1" style="color: #ec4899;"></i> The special person who'll receive this gift
                                        </small>
                                    </div>
                                    
                                    <div class="mb-4">
                                        <label class="form-label" style="color: #be185d; font-weight: 600; font-size: 1rem; margin-bottom: 0.75rem; display: block;">
                                            <i class="fas fa-envelope-open-heart me-2" style="color: #ec4899;"></i>Gift Message <span style="color: #dc3545;">*</span>
                                        </label>
                                        <textarea 
                                            name="gift_message" 
                                            id="giftMessage"
                                            class="form-control-ramadan gift-input-special" 
                                            placeholder="Write your heartfelt message here... Express your love, gratitude, or best wishes!"
                                            rows="4"
                                            maxlength="500"
                                            style="font-size: 1rem; line-height: 1.6; padding: 1rem; border-width: 2px; resize: vertical;"
                                        ></textarea>
                                        <div class="d-flex justify-content-between align-items-center" style="margin-top: 0.5rem;">
                                            <small style="color: #be185d; font-size: 0.875rem;">
                                                <i class="fas fa-info-circle me-1" style="color: #ec4899;"></i> We'll beautifully present your message with the gift
                                            </small>
                                ...
                                <div style="background: linear-gradient(135deg, #fff 0%, #fffbfe 100%); border-radius: 12px; padding: 1.5rem; border: 2px solid #ffc0e0; box-shadow: 0 4px 12px rgba(236, 72, 153, 0.1); position: relative; z-index: 1;">
                                    <h5 style="color: #be185d; margin-bottom: 1.5rem; font-weight: 700; font-size: 1.2rem; text-align: center;">
                                        <i class="fas fa-map-marker-alt me-2" style="color: #ec4899;"></i>Delivery Address
                                    </h5>
                                ...
                                <div class="mb-4">
                                    ...
                                    >
                                    <small style="color: #be185d; display: block; margin-top: 0.5rem; font-size: 0.875rem;">
                                        <i class="fas fa-info-circle me-1" style="color: #ec4899;"></i> Contact number for delivery
                                    </small>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" style="color: #be185d; font-weight: 600; font-size: 1rem; margin-bottom: 0.75rem; display: block;">
                                    ...
                                    <input 
                                        ...
                                        id="city_gift"
                                        class="form-control-ramadan" 
                                        placeholder="Enter delivery city (e.g., Amman, Irbid)"
                                        pattern="[A-Za-z\s]{2,50}"
                                        title="Please enter a valid city name"
                                        style="font-size: 1rem; padding: 0.875rem; border-width: 2px;"
                                    >
                                ...
                                <div class="mb-4">
                                    <label class="form-label" style="color: #be185d; font-weight: 600; font-size: 1rem; margin-bottom: 0.75rem; display: block;">
                                        <i class="fas fa-map-marked-alt me-2" style="color: #ec4899;"></i>Shipping Address <span style="color: #dc3545;">*</span>
                                    </label>
                                    <textarea 
                                ...
                                <div class="mb-4">
                                    <label class="form-label" style="color: #be185d; font-weight: 600; font-size: 1rem; margin-bottom: 0.75rem; display: block;">
                                        <i class="fas fa-comment-dots me-2" style="color: #ec4899;"></i>Delivery Notes <span style="color: #be185d; font-weight: 400; font-size: 0.9rem;">(Optional)</span>
                                    </label>
                                    <textarea 
                                        id="notes_gift"
                                        class="form-control-ramadan" 
                                        placeholder="Special delivery instructions, preferred delivery time, or any message for our delivery team..."
                                        rows="3"
                                        style="font-size: 1rem; line-height: 1.6; padding: 1rem; border-width: 2px; resize: vertical;"
                                    ></textarea>
                                    <small style="color: #be185d; display: block; margin-top: 0.5rem; font-size: 0.875rem;">
                                        <i class="fas fa-lightbulb me-1" style="color: #ec4899;"></i> Example: "Deliver after 6 PM" or "Gate code: 1234"
                                    </small>
                                </div>
                                </div>
                                </div>
                    ...
                    <div class="card-ramadan p-4" style="max-width: 700px; margin: 0 auto; box-shadow: 0 6px 25px rgba(0,0,0,0.15); border: 3px solid rgba(201, 168, 106, 0.3);">
                        <h3 class="mb-4" style="color: var(--purple-color); font-weight: 800; text-align: center; border-bottom: 3px solid var(--gold-color); padding-bottom: 1.5rem; font-size: 2rem;">
                            <i class="fas fa-receipt me-3" style="color: var(--gold-color); font-size: 2rem;"></i>Order Summary
                        </h3>
                        ...
                        <div class="mb-3" style="background: linear-gradient(135deg, #f8f5ff 0%, #fff9f5 100%); padding: 0.75rem; border-radius: 8px; text-align: center;">
                            <small style="color: var(--purple-color); font-weight: 600;">
                                ...
                                <?= count($cart['cart_items']) ?> Item<?= count($cart['cart_items']) != 1 ? 's' : '' ?> in Cart
                            </small>
                        </div>
                        ...
                        <div style="background: linear-gradient(135deg, #f8f5ff 0%, #fff9f5 100%); padding: 1rem; border-radius: 10px; margin-bottom: 1rem;">
                            <div class="d-flex justify-content-between mb-2" style="font-size: 0.95rem;">
                                <span style="color: #666;"><i class="fas fa-calculator me-1"></i>Subtotal:</span>
                                <span style="color: var(--purple-color); font-weight: 600;"><?= $cart['total_amount_formatted'] ?></span>
                            </div>
                            <div class="d-flex justify-content-between mb-2" style="font-size: 0.95rem;">
                                <span style="color: #666;"><i class="fas fa-truck me-1"></i>Shipping:</span>
                        ...
                        <div class="d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, var(--purple-color), var(--purple-dark)); padding: 1.25rem; border-radius: 12px; margin-bottom: 1.5rem; box-shadow: 0 4px 15px rgba(72, 54, 110, 0.3);">
                            ...
                            <span style="color: var(--gold-color); font-size: 1.6rem; font-weight: 900; text-shadow: 0 2px 4px rgba(0,0,0,0.2);"><?= $cart['total_amount_formatted'] ?></span>
                        </div>
                        ...
                        <div style="text-align: center; margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid rgba(201, 168, 106, 0.2);">
                            <small style="color: #666; font-size: 0.85rem;">
                                <i class="fas fa-lock me-1" style="color: #28a745;"></i>Secure checkout - Your information is protected
                            </small>
                        </div>
                    </div>
                </div>
