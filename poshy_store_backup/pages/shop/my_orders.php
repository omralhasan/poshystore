...
<head>
    ...
    <title>My Orders - Poshy Store</title>
...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="card-ramadan p-4 mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    <strong style="color: var(--gold-color);">Total Orders:</strong> <?= count(array_filter($orders, function($o) { return !empty($o['items']); })) ?>
                </div>
            </div>
        </div>
        <?php endif; ?>
            ...
            <?php if (empty($orders_with_items)): ?>
                <div class="empty-state">
                    ...
                    <a href="../../index.php" class="btn-ramadan">
                        <i class="fas fa-shopping-bag me-2" style="color: white;"></i>Start Shopping
                    </a>
                </div>
            <?php else: ?>
                        ...
                        <div class="order-card-body">
                            ...
                            <div class="order-tracking">
                                ...
                                <div class="tracking-steps">
                                    <?php 
                                    $statuses = ['pending' => 'Pending', 'shipped' => 'Shipped', 'delivered' => 'Delivered'];
    ...
    <script>
        ...
        function cancelOrder(orderId) {
            const confirmMessage = '⚠️ Cancel Order Confirmation\n\n' +
            ...
            .then(data => {
                if (data.success) {
                    ...
                    if (data.stock_restored && data.restored_items) {
                        message += '\n\n📦 Stock Restored:';
                        data.restored_items.forEach(item => {
                            message += `\n  • Product #${item.product_id}: +${item.quantity_restored} units returned to inventory`;
                        });
                    }
                    alert(message);
                    location.reload();
