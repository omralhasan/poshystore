...
$mysqli = new mysqli("localhost", "poshy_user", "", "poshy_db", 0, "/var/run/mysqld/mysqld.sock");
...
// Get counts
$orders_count = $mysqli->query("SELECT COUNT(*) FROM orders")->fetch_row()[0] ?? 0;
$items_count = $mysqli->query("SELECT COUNT(*) FROM order_items")->fetch_row()[0] ?? 0;
...
// Verify
$orders_after = $mysqli->query("SELECT COUNT(*) FROM orders")->fetch_row()[0] ?? 0;
$items_after = $mysqli->query("SELECT COUNT(*) FROM order_items")->fetch_row()[0] ?? 0;
