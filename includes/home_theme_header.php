...
<?php else: ?>
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=Playfair+Display:wght@600;700;800&family=Montserrat:wght@300;400;500;600;700&display=swap" rel="stylesheet">
<?php endif; ?>

<style>
    /* ============================================
       POSHY STORE — Soft Luxury Design System
       Inspired by Beauty Box Jordan
       ============================================ */
    :root {
        /* Color Palette */
        --bb-bg: #F9F9F9;
        ...
        --bb-border-hover: rgba(0,0,0,0.15);
        --bb-gold: #C5A059;
        --bb-gold-soft: #D8BE85;
        --bb-gold-bg: rgba(197,160,89,0.06);
        --bb-rose: #E8C4B8;
        --bb-rose-soft: #F5E6E0;
        --bb-red: #E53935;
        --bb-green: #43A047;
        ...
        --font-body: <?php echo ($lang === 'ar') ? "'Tajawal', 'Cairo', sans-serif" : "'Inter', 'Montserrat', sans-serif"; ?>;
    ...
    * { box-sizing: border-box; }
    ...
    .announcement-bar i { color: var(--bb-gold); }
    ...
    .navbar-brand-ramadan:hover { opacity: 0.7; }
    ...
    .btn-ramadan-secondary {
        background: #fff;
        color: var(--bb-charcoal);
        border: 1.5px solid var(--bb-border-hover);
        border-radius: var(--radius-full);
        font-weight: 600;
    ...
    [dir="rtl"] .mobile-menu { right: auto; left: -300px; transition: left 0.35s var(--ease); }
    ...
    .mobile-menu-links { padding: .5rem 0; }
    ...
    .mobile-menu-link:hover { background: rgba(0,0,0,0.03); color: var(--bb-black); border-left-color: var(--bb-black); }
    .mobile-menu-link i { color: var(--bb-text-secondary); width: 20px; text-align: center; }

    .mobile-menu-link-danger { color: #dc2626; }
    .mobile-menu-link-danger i { color: #dc2626; }
    .mobile-menu-divider { height: 1px; background: rgba(0,0,0,.06); margin: .4rem 1.2rem; }
    ...
    @media (max-width: 768px) {
        .ramadan-navbar { padding: 0; }
        .navbar-main-row { height: 52px; }
        .navbar-brand-ramadan { font-size: 1.15rem !important; letter-spacing: 0.15em; }
        .navbar-brand-ramadan .logo-subtitle { font-size: .4rem !important; letter-spacing: .22em !important; }
        .nav-icon-ramadan { font-size: 1rem; min-width: 32px; min-height: 32px; padding: 0.3rem 0.4rem; }
        ...
        [dir="rtl"] .bottom-nav-badge { left: auto; right: calc(50% + 5px); }
    }
    ...
    .footer-ramadan a { color: rgba(255,255,255,0.7); text-decoration: none; transition: color .2s var(--ease); }
    .footer-ramadan a:hover { color: #fff; }
    ...
    /* ============ UTILITY ============ */
    .text-gold { color: var(--bb-gold); }
    .bg-gold { background: var(--bb-gold); }
</style>
