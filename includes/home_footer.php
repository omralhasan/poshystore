...
#chatbot-toggle {
    ...
    background: linear-gradient(135deg, #111111, #c5a059);
    color: white; font-size: 1.5rem; cursor: pointer;
    box-shadow: 0 4px 20px rgba(17,17,17,0.35);
    transition: transform 0.3s, box-shadow 0.3s;
    display: flex; align-items: center; justify-content: center;
}
#chatbot-toggle:hover { transform: scale(1.1); box-shadow: 0 6px 25px rgba(17,17,17,0.45); }
...
.chatbot-option-btn {
    background: white; border: 1.5px solid rgba(197,160,89,0.35);
    border-radius: 10px; padding: 10px 14px; text-align: left;
    font-size: 0.85rem; font-weight: 600; color: #111111;
    cursor: pointer; transition: all 0.2s; display: flex; align-items: center; gap: 8px;
}
.chatbot-option-btn:hover {
    background: linear-gradient(135deg, #fffdf8, #ffffff);
    border-color: #c5a059; transform: translateX(4px);
}
.chatbot-option-btn i { font-size: 1rem; width: 20px; text-align: center; }

.chat-bubble a {
    color: #111111; font-weight: 700; text-decoration: underline;
}
.chat-bubble.bot a { color: #111111; }
.back-btn {
    background: none; border: 1.5px solid rgba(197,160,89,0.35);
    border-radius: 8px; padding: 6px 12px; font-size: 0.8rem;
    color: #111111; cursor: pointer; margin-top: 8px;
    transition: all 0.2s;
}
.back-btn:hover { background: #fff8e8; }
