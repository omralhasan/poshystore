...
$translations = [
    'ar' => [
        ...
        'shipping_detail' => 'نوفر شحناً مجانياً للطلبات التي تزيد عن 35 د.أ داخل الأردن. يتم التوصيل خلال 3-5 أيام عمل. للطلبات العاجلة، يمكنك اختيار الشحن السريع (2-3 أيام عمل).',
        'add_photos' => 'إضافة صور',
        'max_3_photos' => '3 صور كحد أقصى',
        'free_shipping_over_30' => 'شحن مجاني للطلبات فوق 35 د.أ',
    ...
    'en' => [
        ...
        'shipping_detail' => 'We offer free shipping on orders over 35 JOD within Jordan. Delivery takes 3-5 business days. For urgent orders, choose express shipping (2-3 business days).',
        'add_photos' => 'Add Photos',
        'max_3_photos' => 'Max 3 photos',
        'free_shipping_over_30' => 'Free shipping over 35 JOD',
