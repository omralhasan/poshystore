<?php
// Import remaining how-to-use data from CSV

require_once '../includes/db_connect.php';

$csv_file = 'import_pdf_remaining.csv';
...
if (($handle = fopen($csv_file, 'r')) !== false) {
    ...
    while (($line = fgetcsv($handle)) !== false) {
        ...
        $query = "SELECT id FROM products WHERE name_en = ? LIMIT 1";
...
echo "\n=== Import Summary ===\n";
echo "Successfully imported: $imported remaining products\n";
